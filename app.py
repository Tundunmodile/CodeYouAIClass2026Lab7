...
async def main():
    ...
    global researcher_agent, writer_agent, editor_agent  # Add this line at the top of main()
    ...
    template_path = os.path.join(os.path.dirname(__file__), "templates", "researcher.json")
    with open(template_path, "r") as f:
        researcher_data = json.load(f)
        researcher_prompt = researcher_data.get("template", "You are a helpful research assistant.")
    
    template_path = os.path.join(os.path.dirname(__file__), "templates", "writer.json")
    with open(template_path, "r") as f:
        writer_data = json.load(f)
        writer_prompt = writer_data.get("template", "You are a helpful writing assistant.")
    
    template_path = os.path.join(os.path.dirname(__file__), "templates", "editor.json")
    with open(template_path, "r") as f:
    ...
    # TODO: Create writer and editor agents, and build graph
